...
namespace HotelManagementCRUD.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HotelID,HotelName,ZipCode,City,Price")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HotelID,HotelName,ZipCode,City,Price")] Hotel hotel)
        {
            if (id != hotel.HotelID)
            {
                return NotFound();
